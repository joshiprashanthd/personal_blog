	...
	return (
		<section className="flex flex-col justify-center">
			...
			<div className="flex items-center">
				<h1 className="mb-1 font-ui text-2xl font-semibold sm:text-4xl">
					Prashant Joshi
				</h1>
				<div className="mx-4 flex-1 border-t-2 border-primary-light dark:border-primary-dark" />
			</div>
			<div className="my-8">
				<h1 className="text-base font-medium text-primary-light dark:text-primary-dark sm:text-lg font-ui">
					About ME
				</h1>
				<p>
